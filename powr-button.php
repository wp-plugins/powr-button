<?php
    ...
    Description: Create your own fully-customizable button! Add the widget to your theme, or create a Button on ANY page or post by using the shortcode [powr-button]. Then, simply visit your site and click the settings icon to customize your Button right in the page. Many more plugins & tutorials at POWr.io.
    Author: POWr.io
    Version: 1.1
